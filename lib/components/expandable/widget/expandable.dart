...
import 'package:katja/components/expandable/repository/expandable_repository.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Layout(
      ...
      body: Container(
        ...
        child: ListView(
          children:
          _listOfExpansions.map(
                  (expansionTile) => expansionTile).toList(),
        )
      )
    );
  }
