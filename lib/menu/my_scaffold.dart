...
import 'package:katja/components/common/button/raised_gradient_button.dart';
import 'package:katja/components/common/style/styles.dart';
import 'package:katja/repositories/MenuRepository.dart';
                  ...
                  actions: <Widget>[
                    Container(
                      ...
                      child: RaisedButton(
                          ...
                          onPressed: () {
                            _launchURL('https://codecanyon.net/user/creativeform/portfolio');
                          }),
                    )
                  ],
                ),
                            ...
                            children: <Widget>[
                              ConstrainedBox(
                                ...
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    Text(
                                      'Katja | Flutter UI Theme / Template App | Multipurpose Starter App',
                                      style: TextStyle(
                                          color: Styles.helperTextColor,
                                          fontSize: Styles.h2,
                                    ...
                                    Row(
                                      ...
                                      children: <Widget>[
                                        ...
                                        InkWell(
                                          ...
                                          onTap: () {
                                            _launchURL('http://csform.com/flutter-all-theme/flutter-katja/documetation/');
                                          },
                                        )
                                      ],
                                    )
